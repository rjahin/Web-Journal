...
var _Transaction_instances, _Transaction_mutex, _Transaction_state, _Transaction_runCommit, _Transaction_processBeginResults, _Transaction_parseRunSuccess, _Transaction_beginTransactionAsync, _Transaction_withBeginTransaction;
...
(function (TransactionState) {
    TransactionState[TransactionState["NOT_STARTED"] = 0] = "NOT_STARTED";
    TransactionState[TransactionState["IN_PROGRESS"] = 1] = "IN_PROGRESS";
...
class Transaction extends request_1.DatastoreRequest {
    constructor(datastore, options) {
        ...
        _Transaction_state.set(this, TransactionState.NOT_STARTED);
        /**
    ...
    get(keys, optionsOrCallback, cb) {
        ...
        __classPrivateFieldGet(this, _Transaction_instances, "m", _Transaction_withBeginTransaction).call(this, options.gaxOptions, () => {
    ...
    run(optionsOrCallback, cb) {
        ...
        __classPrivateFieldGet(this, _Transaction_mutex, "f").runExclusive(async () => {
            if (__classPrivateFieldGet(this, _Transaction_state, "f") === TransactionState.NOT_STARTED) {
...
_Transaction_mutex = new WeakMap(), _Transaction_state = new WeakMap(), _Transaction_instances = new WeakSet(), _Transaction_runCommit = function _Transaction_runCommit(gaxOptions, callback) {
    if (this.skipCommit) {
    ...
    if (err) {
        ...
        __classPrivateFieldGet(this, _Transaction_instances, "m", _Transaction_parseRunSuccess).call(this, runResults);
        callback(null, this, resp);
    }
}, _Transaction_parseRunSuccess = function _Transaction_parseRunSuccess(runResults) {
    const resp = runResults.resp;
    this.id = resp.transaction;
    __classPrivateFieldSet(this, _Transaction_state, TransactionState.IN_PROGRESS, "f");
